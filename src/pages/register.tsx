...
const Register = () => {
  ...
  return (
    <div className="h-screen w-full relative flex items-center justify-center bg-slate-50 overflow-hidden font-sans">
      ...
      {/* --- ANIMATED BACKGROUND (Konsisten dengan Login: Biru & Ungu) --- */}
      <div className="absolute inset-0 w-full h-full bg-white z-0">
         ...
         {/* Blob 2 (Bottom Right - Ungu) - Disamakan dengan Login */}
         <motion.div
        ...
        <Card className="border-slate-200/60 shadow-xl shadow-slate-200/50 bg-white/80 backdrop-blur-xl">
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <Button
                className="w-full h-10 font-medium shadow-lg shadow-primary/20 hover:shadow-primary/40 bg-gradient-to-r from-primary to-blue-600 hover:to-blue-700 transition-all"
                type="submit"
                disabled={loading}
              >
